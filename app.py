...
# Model Coefficients
INTERCEPT = 2.6427
COEF_ACETALDEHYDE = -0.5820
COEF_CHLORIDE = -0.0168
COEF_DISTILLATION = -0.2675
COEF_ACETAL = 1.1978
...
z = INTERCEPT + (COEF_ACETALDEHYDE * acetaldehyde) + (COEF_CHLORIDE * chloride) + (COEF_DISTILLATION * distillation) + (COEF_ACETAL * acetal)
